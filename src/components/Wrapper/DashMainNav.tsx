...
const DashMainNav = () => {
  ...
  return (
    <nav className=" w-full fixed top-0 h-[12vh] z-[99999999999999999] bg-white">
      <div className="lg:pl-[220px] flex justify-center items-center  w-full h-full lg:w-[95%]  bg-white">
